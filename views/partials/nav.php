    ...
    <div class="user-menu">
      <div class="user-menu__items">
        <div class="user-menu__item">
          <button class="user-menu__btn" type="button" aria-label="Menu modal" data-dropdown-id="menu">
            <svg fill="currentColor" viewBox="0 0 44 44" width="20px" height="20px" class="x1lliihq x1k90msu x2h7rmj x1qfuztq x198g3q0 x1qx5ct2 xw4jnvo"><circle cx="7" cy="7" r="6"></circle><circle cx="22" cy="7" r="6"></circle><circle cx="37" cy="7" r="6"></circle><circle cx="7" cy="22" r="6"></circle><circle cx="22" cy="22" r="6"></circle><circle cx="37" cy="22" r="6"></circle><circle cx="7" cy="37" r="6"></circle><circle cx="22" cy="37" r="6"></circle><circle cx="37" cy="37" r="6"></circle></svg>
          </button>
          <?php require_once 'modal-menu.php';?>
        </div>
        <div class="user-menu__item">
          <button class="user-menu__btn" type="button" aria-label="Chat modal" data-dropdown-id="chat">
          ...
          <?php require_once 'modal-chat.php';?>
        </div>
        <div class="user-menu__item">
          <button class="user-menu__btn" type="button" aria-label="Notification modal" data-dropdown-id="notification">
          ...
          <?php require_once 'modal-notification.php';?>
        </div>
        <div class="user-menu__item">
          <button class="user-menu__btn" type="button" aria-label="Account modal" data-dropdown-id="account">
            <img src="<?=$avatar?>" alt="...">
          </button>
          <?php require_once 'modal-account.php';?>
        </div>
      </div>
    </div>
  </header>